    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <form enctype="multipart/form-data" action="{{ url('product-role') }}{{ '/' . $product_role->id }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            is-invalid
                            @enderror"
                                id="title" placeholder="Enter name" value="{{ $product_role->title }}">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="5"
                                placeholder="Enter Description">{{ $product_role->description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid
                            @enderror"
                                    id="link_url" placeholder="Enter Link Url" value="{{ $product_role->link_url }}">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                @php
                                    $ext = strtolower(pathinfo($product_role->image_url, PATHINFO_EXTENSION));
                                ...
                                @endphp
                                @if (!empty($product_role->image_url))
                                    <a target="_blank" href="{{ URL::to('/') . '/files/' . $product_role->image_url }}"
                                        class="btn-link text-secondary"><i class="far fa-fw {{ $icon }}"></i>
                                        {{ $product_role->image_url }}</a>
                                @endif
                        ...
                        @php
                            $arrayAttachments = explode(';', $product_role->attachments);
                        @endphp
                        <ul class="list-unstyled">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('product-role/') }}" class="btn btn-danger">Cancel</a>
