...
@section('content')
    @php
        ...
        function gen($id)
        {
            $btnUpdate = '<a href=' . url('product-role') . '/' . $id . '/edit' . ' class="btn-update btn btn-success btn-xs " title="Details"><i class="fa fa-lg fa-fw fa-pen"></i></a>';
        ...
        foreach ($product_roles as $value) {
        ...
        $(document).ready(function() {
            ...
            $('.btn-delete').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        window.location.href = "{!! url('/product-role/delete') !!}" + "/" + id
