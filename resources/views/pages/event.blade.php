...
@section('content')
    ...
    @endphp
    <x-adminlte-card title="Information & Event" theme="primary">
        @if (session('failed'))
        ...
        <a href="{{ url('/event/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Information &
            Event</a>
