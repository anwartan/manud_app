...
@section('content')
    @php
        ...
        function gen($id)
        {
            $btnUpdate = '<a href=' . url('report') . '/' . $id . '/edit' . ' class="btn-update btn btn-success btn-xs " title="Details"><i class="fa fa-lg fa-fw fa-pen"></i></a>';
    ...
    <x-adminlte-card title="Lowongan Information" theme="primary">
        ...
        <a href="{{ url('/report/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Report</a>
