            ...
            <div class="col-lg-12 px-0">
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        <img class="img-fluid h-100" src="{{ URL::to('/') . '/files/' . $report->image_url }}"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">{{ $report->title }}</h4>
                            @if (!empty($report->link_url))
                                <a target="_blank" href="{{ $report->link_url }}"
