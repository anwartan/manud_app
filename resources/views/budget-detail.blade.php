                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">{{ $budget->title }}</h4>
                            @if (!empty($budget->link_url))
                                <a target="_blank" href="{{ $budget->link_url }}"
                    ...
                    <div class="col-12 text-justify">
                        <div class="bg-white border border-top-0 p-4">
                            <p class="text-dark">Tanggal : {{ $budget->getBudgetDateString() }}</p>
                            <p class="text-dark">{{ $budget->description }}</p>
                            @php
