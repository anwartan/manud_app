            ...
            <div class="col-lg-12 px-0">
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        <img class="img-fluid h-100" src="{{ URL::to('/') . '/files/' . $role_product->image_url }}"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">{{ $role_product->title }}</h4>
                            @if (!empty($role_product->link_url))
                                <a target="_blank" href="{{ $role_product->link_url }}"
                    ...
                    <div class="col-12 text-justify">
                        <div class="bg-white border border-top-0 p-4">
                            ...
                            <p class="text-dark">{{ $role_product->description }}</p>
                            @php
                                $arrayAttachments = explode(';', $role_product->attachments);
                            @endphp
